...
public class BillboardHot1003 {
	  public static void main(String[] args) {
		    ...
		    OptionalInt min = table.stream().mapToInt(Billboard::getWeeksonchart).min();
		    if (min.isPresent()) {
		      System.out.printf("Lowest number of weeks on chart of songs was %d\n", min.getAsInt());
		    } else {

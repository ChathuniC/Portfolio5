...
public class BillboardHot1004 {
	  ...
	  public static void main(String[] args) {
		    ...
		    System.out.println("Billboard records which have 1 peak rank");
		    table.stream().filter(billboard -> billboard.getPeakrank() == 1)
		        .forEach(System.out::println);

		    System.out.println();
		    System.out.println("Songs with 20 weeks on chart");
		    table.stream().filter(billboard -> billboard.getWeeksonchart() == 20)
		        .forEach(System.out::println);
